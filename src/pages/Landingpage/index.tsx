...
function FancyHorizontalSeparator() {
  return (
    <div className="relative flex items-center justify-center w-full my-16">
      {/* Outer glow effect */}
      <div
        className="h-2 bg-[#0D4F8B] rounded-full shadow-[0_0_12px_4px_#0D4F8B55] blur-[4px]"
        style={{ width: '200px' }}
      />
      {/* White inner part */}
        ...
        <nav className="fixed top-10 left-0 w-full flex justify-center z-50 bg-transparent" style={{height: NAVBAR_HEIGHT}}>
          <div className="flex items-center bg-black rounded-xl px-4 py-3 w-[95vw] max-w-5xl shadow border border-white/20 pointer-events-auto">
            ...
            <div className="flex items-center gap-2 md:ml-6 pr-2 ml-auto">
              <Button
                className="hidden md:inline-flex items-center gap-2 bg-gradient-to-b from-[#3B9EFF] to-[#0A7AFF] text-white px-5 py-2 rounded-full font-semibold shadow-[0_0_16px_rgba(10,122,255,0.5)] hover:shadow-[0_0_24px_rgba(10,122,255,0.7)] hover:brightness-110 transition-all border border-white/20"
...
/>
          ...
          <div className="flex justify-center mb-2 mt-3">
            <span
              className="flex items-center justify-center h-9 px-4 bg-[#0D4F8B]/20 border border-white/15 rounded-full text-white font-medium text-sm shadow mb-3"
              style={{
                cursor: 'default',
                userSelect: 'none',
                transition: 'none'
          ...
          <div className="mt-4 mb-10">
            <div className="flex justify-center">
              <span className="relative inline-flex items-center gap-2 px-5 py-2 rounded-none border border-white/20 bg-black text-white/90 font-medium text-sm shadow animated-pill">
                <span className="ml-2 h-2 w-2 rounded-full bg-[#0D4F8B] inline-block"></span>
                #1 Futures Trading Allrounder
                <span className="inline-block align-middle ml-1" style={{ verticalAlign: 'middle' }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="#0D4F8B" xmlns="http://www.w3.org/2000/svg" style={{ filter: 'drop-shadow(0 0 4px #0D4F8B)' }}>
                    <path d="M6.5 20a4.5 4.5 0 0 1-.42-8.98A7 7 0 0 1 19.5 9.5a4.5 4.5 0 0 1 .5 8.97V20H6.5z" />
                  </svg>
                </span>
          ...
          {/* Headline */}
            ...
            <div className="w-full flex justify-center mb-12">
              <div className="flex md:scale-100 z-10 bg-black">
                <div className="border border-[#0D4F8B] shadow-[0_0_24px_2px_#0D4F8Baa] rounded-lg p-6 flex flex-col bg-black min-w-[300px]">
                  ...
                  <button
                    className="relative h-12 px-8 text-lg font-medium text-white bg-[#0D4F8B]/20 border border-white/15 hover:bg-[#0D4F8B]/20 transition-transform hover:scale-105 overflow-hidden group flex items-center gap-2 justify-center w-full rounded-md"
                    onClick={() => navigate('/auth/signup')}
                  >
                    <Key size={18} />
                    Start for free
            ...
            >
              ...
              <div
                style={{
                  ...
                  width: '300px',
                  height: '40px',
                  background: 'radial-gradient(ellipse 40% 100% at 50% 100%, rgba(13, 79, 139, 0.25) 0%, rgba(13, 79, 139, 0.15) 25%, rgba(13, 79, 139, 0.05) 60%, transparent 100%)',
                  pointerEvents: 'none',
                  zIndex: -1,
                  filter: 'blur(6px)',
                }}
              ...
              <div
                style={{
                  ...
                  width: '200px',
                  height: '1px',
                  background: 'linear-gradient(to right, transparent 0%, rgba(13, 79, 139, 0.3) 30%, rgba(13, 79, 139, 0.4) 50%, rgba(13, 79, 139, 0.3) 70%, transparent 100%)',
                  boxShadow: '0 -4px 6px 0px rgba(13, 79, 139, 0.2)',
                  pointerEvents: 'none',
                  zIndex: 2,
                }}
              />
              ...
              >
                ...
                <defs>
                  <linearGradient id="globeGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="rgba(13, 79, 139, 0.1)" />
                    <stop offset="100%" stopColor="rgba(13, 79, 139, 0.05)" />
                  </linearGradient>
                </defs>
                ...
                >
                  ...
                  <animate
                    ...
                    values="rgba(13, 79, 139, 0.6);rgba(13, 79, 139, 0)"
                    keyTimes="0;1"
                    dur="1s"
                    begin="1.1s"
                    repeatCount="indefinite"
                ...
                >
                  ...
                  <animate
                    attributeName="stroke"
                    values="rgba(13, 79, 139, 0.4);rgba(13, 79, 139, 0)"
                    keyTimes="0;1"
                    dur="1s"
                    begin="1.3s"
                    repeatCount="indefinite"
              ...
              <div className="flex flex-col items-center flex-1">
                {(() => { const [ref, val] = useCountUpOnVisible(375); return (
                  <span ref={ref} className="text-4xl font-bold text-white">
                    {val}<span className="text-[#0D4F8B]">+</span>
                  </span>
                ); })()}
          ...
          <div className="flex flex-col items-center mb-12" style={{ marginTop: '48px' }}>
            <span
              className="flex items-center justify-center h-9 px-4 bg-[#0D4F8B]/20 border border-white/15 rounded-full text-white font-medium text-sm shadow mb-8 mt-2"
              style={{
                cursor: 'default',
                userSelect: 'none',
                transition: 'none'
            ...
            <p className="text-center text-white text-3xl md:text-4xl font-extrabold mb-4">
              <span style={{ color: '#0D4F8B', filter: 'drop-shadow(0 0 6px #0D4F8B)', fontSize: '0.75em', display: 'inline-block', transform: 'translateY(-0.18em)', marginRight: '0.3em' }}>⧼</span>
              Connect every futures prop firm account seamlessly
              <span style={{ color: '#0D4F8B', filter: 'drop-shadow(0 0 6px #0D4F8B)', fontSize: '0.75em', display: 'inline-block', transform: 'translateY(-0.18em)', marginLeft: '0.3em' }}>⧽</span>
            </p>
  ...
  >
    ...
    >
          ...
          <div ref={pricingRef} style={{ scrollMarginTop: NAVBAR_HEIGHT + 52, marginTop: '48px' }} className="flex flex-col items-center mb-6">
            ...
            <div className="mb-2">
              <span className="block text-center text-white text-2xl md:text-4xl font-extrabold" style={{ color: '#fff', fontWeight: 800 }}>
                <span style={{ color: '#0D4F8B', filter: 'drop-shadow(0 0 6px #0D4F8B)', fontSize: '0.75em', display: 'inline-block', transform: 'translateY(-0.18em)', marginRight: '0.3em' }}>⧼</span>
                Choose the plan that matches your needs<span style={{ color: '#0D4F8B', filter: 'drop-shadow(0 0 6px #0D4F8B)', fontSize: '0.75em', display: 'inline-block', transform: 'translateY(-0.18em)', marginLeft: '0.3em' }}>⧽</span>
              </span>
            ...
            <div className="w-full max-w-5xl px-2 md:px-6 mb-16 md:scale-110">
              <div className="flex flex-col h-full">
                <div className="border border-white/20 rounded-lg p-4 h-full flex flex-col shadow-[0_0_20px_2px_rgba(13,79,139,0.5)]">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-lg font-semibold text-[#0D4F8B]">Trade Journaling</h3>
                    <div className="flex items-end gap-1">
                      <span className="text-2xl font-bold text-white">$0</span>
                      <span className="text-sm text-white/70">/month</span>
                    </div>
                  ...
                  <ul className="text-sm text-white/90 space-y-1 mb-4 flex-1">
                    <li className="flex items-center gap-2"><span className="text-[#0D4F8B]">✓</span>Manual Trade Input</li>
                    <li className="flex items-center gap-2"><span className="text-[#0D4F8B]">✓</span>Statistics & In depth Trade Journaling</li>
                  </ul>
                  <button
                    onClick={() => navigate('/auth/signup')}
                    className="w-full font-medium py-1 px-4 rounded-md transition-colors bg-[#0D4F8B] hover:bg-[#0D4F8B]/90 text-white"
                  >
                    Join for free here
                  </button>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl mt-4 px-2 md:px-6">
              ...
              <div className="flex flex-col h-full md:scale-110 z-10 bg-black">
                <div className="flex flex-col h-full">
                  <div className="border border-white/20 rounded-lg p-4 h-full flex flex-col shadow-[0_0_20px_2px_rgba(13,79,139,0.5)]">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-lg font-semibold text-[#0D4F8B]">Trade Copier</h3>
                      <div className="flex items-end gap-1">
                    ...
                    <ul className="text-sm text-white/90 space-y-1 mb-4 flex-1">
                      <li className="flex items-center gap-2"><span className="text-[#0D4F8B]">✓</span>Trade Journaling</li>
                      <li className="flex items-center gap-2"><span className="text-[#0D4F8B]">✓</span>Automatic trade syncing</li>     
                      <li className="flex items-center gap-2"><span className="text-[#0D4F8B]">✓</span>Copy <span className="text-[#0D4F8B] font-bold drop-shadow-[0_0_6px_#0D4F8B]">unlimited Accounts</span></li>
                    </ul>
                    <button
                      onClick={() => navigate('/auth/signup')}
                      className="w-full font-medium py-1.5 px-3 rounded-md transition-colors bg-[#0D4F8B] hover:bg-[#0D4F8B]/90 text-white text-sm"
                    >
                      Get Access
                    </button>
                  </div>
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="border border-white/20 rounded-lg p-4 h-full flex flex-col bg-black relative overflow-hidden">
                  <div 
                    ...
                    style={{
                      backgroundImage: `
                        linear-gradient(rgba(13, 79, 139, 0.3) 1px, transparent 1px),
                        linear-gradient(90deg, rgba(13, 79, 139, 0.3) 1px, transparent 1px)
                      `,
                  ...
                  <div className="flex-1 flex items-center justify-center mb-4 relative z-10 w-full">
                    ...
                    <svg viewBox="0 0 140 150" className="relative w-52 h-52">
                      ...
                      <polygon
                        ...
                        fill="none"
                        stroke="rgba(13, 79, 139, 0.12)"
                        strokeWidth="1"
                        strokeLinejoin="round"
                      />

                      {/* Glowing outline dot tracing the star path */}
                      <circle r="5" fill="none" stroke="#0D4F8B" strokeWidth="1.5" filter="url(#starDotGlow)" opacity="1">
                        <animateMotion
                          dur="4s"
                          repeatCount="indefinite"
                      ...
                      {/* Trailing comet tail */}
                      <circle r="3" fill="none" stroke="#0D4F8B" strokeWidth="1" opacity="0.4" filter="url(#starDotGlow)">
                        <animateMotion
                          dur="4s"
                          repeatCount="indefinite"
                          begin="-0.08s"
                      ...
                      <circle r="2" fill="none" stroke="#0D4F8B" strokeWidth="0.8" opacity="0.2" filter="url(#starDotGlow)">
                        <animateMotion
                          dur="4s"
                          repeatCount="indefinite"
                          begin="-0.16s"
                      ...
                      <circle cx="114" cy="58" r="1.5" fill="#0D4F8B" filter="url(#starDotGlow)">
                        <animate attributeName="opacity" values="0;1;0" dur="2s" begin="0.5s" repeatCount="indefinite" />
                        <animate attributeName="r" values="0.5;2.5;0.5" dur="2s" begin="0.5s" repeatCount="indefinite" />
                      </circle>
                      <circle cx="26" cy="58" r="1.5" fill="#0D4F8B" filter="url(#starDotGlow)">
                      ...
                      <circle cx="95.5" cy="111" r="1.5" fill="#0D4F8B" filter="url(#starDotGlow)">
                      ...
                      <circle cx="44.5" cy="111" r="1.5" fill="#0D4F8B" filter="url(#starDotGlow)">
                      ...
                      <circle cx="70" cy="25" r="1.5" fill="#0D4F8B" filter="url(#starDotGlow)">
                  ...
                  >
                    <svg
                      className="absolute inset-0 w-full h-full pointer-events-none"
                      style={{
                        filter: 'drop-shadow(0 0 3px rgba(13,79,139,0.8))'
                      }}
                    >
                      <rect
                        x="0.5"
                  ...
                  Upgrade your Trading <Zap size={20} style={{ color: '#0D4F8B' }} className="relative z-20" />
                  </button>
                </div>
              </div>
            </div>
          ...
          {/* Contact Button and Section */}
                    ...
                    <div style={{ scrollMarginTop: NAVBAR_HEIGHT + 52, marginTop: '48px' }} className="flex flex-col items-center mb-8">
                      ...
                      <div className="mb-2">
                        <span className="block text-center text-white text-2xl md:text-4xl font-extrabold" style={{ color: '#fff', fontWeight: 800 }}>
                          <span style={{ color: '#0D4F8B', filter: 'drop-shadow(0 0 6px #0D4F8B)', fontSize: '0.75em', display: 'inline-block', transform: 'translateY(-0.18em)', marginRight: '0.3em' }}>⧼</span>
                          Take a peek at what our Trading-Allrounder can do<span style={{ color: '#0D4F8B', filter: 'drop-shadow(0 0 6px #0D4F8B)', fontSize: '0.75em', display: 'inline-block', transform: 'translateY(-0.18em)', marginLeft: '0.3em' }}>⧽</span>
                        </span>
                        ...
                        <div className="w-full max-w-6xl px-4">
                                ...
                                <div key={btn.id} className="flex flex-col items-center">
                                  <button
                                    ...
                                    className={`
                                      ...
                                      ${isActive
                                        ? 'bg-gradient-to-b from-[rgba(13,79,139,0.8)] to-[rgba(255, 255, 255, 0.8)] text-white shadow-[0_0_10px_2px_rgba(13,79,139,0.4)] border border-[rgba(13,79,139,0.8)]'
                          ...
                          <div className="relative overflow-hidden rounded-xl w-full glow-border-soft bg-black" style={{ minHeight: 400 }}>
                            ...
                            <div className="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                              ...
                              >
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0D4F8B" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="-ml-1">
                                  <path d="M3 9v12h12" />
                                  <path d="M21 15V3H9" />
                                  <path d="M21 3l-7 7" />
                                </svg>
          ...
          <div ref={contactRef} style={{ scrollMarginTop: NAVBAR_HEIGHT + 52 }} className="flex flex-col items-center mb-6">
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                style={{ filter: 'drop-shadow(0 0 6px #0D4F8B)' }}
              >
      ...
      <style>{`
        ...
        .glow-border {
          box-shadow: 0 0 32px 2px rgba(13, 79, 139, 0.35), 0 0 0 2px rgba(255,255,255,0.08);
          transition: box-shadow 0.3s;
        }
        .glow-border:hover {
          box-shadow: 0 0 32px 2px rgba(13, 79, 139, 0.35), 0 0 0 3px rgba(255,255,255,0.08);
        }
        .glow-border-soft {
          box-shadow: 0 0 16px 1px rgba(13, 79, 139, 0.175), 0 0 0 1px rgba(255,255,255,0.04);
          transition: box-shadow 0.3s;
        }
        .glow-border-soft:hover {
          box-shadow: 0 0 16px 1px rgba(13, 79, 139, 0.175), 0 0 0 2px rgba(255,255,255,0.04);
        }
        ...
        @keyframes glowPulse {
          0% { box-shadow: 0 0 8px #0D4F8B, 0 0 16px rgba(13, 79, 139, 0.4); }
          50% { box-shadow: 0 0 16px #0D4F8B, 0 0 32px rgba(13, 79, 139, 0.8); }
          100% { box-shadow: 0 0 8px #0D4F8B, 0 0 16px rgba(13, 79, 139, 0.4); }
        }
